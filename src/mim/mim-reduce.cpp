...
#define OUTPUT_PATH  "reduce_mim.txt"
...
inline void extract_3_answer(int thr_id) {
    ...
    deserialize_id(answer_3[thr_id], answer_3_buffer_num[thr_id][0], dfs_path[thr_id][0]);
    answer_3[thr_id][answer_3_buffer_num[thr_id][0] ++] = ',';
    deserialize_id(answer_3[thr_id], answer_3_buffer_num[thr_id][0], dfs_path[thr_id][1]);
    answer_3[thr_id][answer_3_buffer_num[thr_id][0] ++] = ',';
    deserialize_id(answer_3[thr_id], answer_3_buffer_num[thr_id][0], dfs_path[thr_id][2]);
    answer_3[thr_id][answer_3_buffer_num[thr_id][0] ++] = '\n';
}

inline void extract_4_answer(int thr_id) {
    answer_4_num[thr_id][0] ++;
    deserialize_id(answer_4[thr_id], answer_4_buffer_num[thr_id][0], dfs_path[thr_id][0]);
    answer_4[thr_id][answer_4_buffer_num[thr_id][0] ++] = ',';
    deserialize_id(answer_4[thr_id], answer_4_buffer_num[thr_id][0], dfs_path[thr_id][1]);
    answer_4[thr_id][answer_4_buffer_num[thr_id][0] ++] = ',';
    deserialize_id(answer_4[thr_id], answer_4_buffer_num[thr_id][0], dfs_path[thr_id][2]);
    answer_4[thr_id][answer_4_buffer_num[thr_id][0] ++] = ',';
    deserialize_id(answer_4[thr_id], answer_4_buffer_num[thr_id][0], dfs_path[thr_id][3]);
    answer_4[thr_id][answer_4_buffer_num[thr_id][0] ++] = '\n';
}
...
int answer_5[MAX_THR][MAX_ANSW][5];
int answer_6[MAX_THR][MAX_ANSW][6];
int answer_7[MAX_THR][MAX_ANSW][7];
...
inline void extract_forward_2_path(int thr_id) {
    ...
    for (int i=sorted_backward_3_path_from[thr_id][v]; i<sorted_backward_3_path_to[thr_id][v]; ++i) {
        ...
        memcpy(answer_5[thr_id][answer_5_6_7_num[thr_id][0]], dfs_path[thr_id], sizeof(int) * 3);
        answer_5[thr_id][answer_5_6_7_num[thr_id][0]][3] = y;
        answer_5[thr_id][answer_5_6_7_num[thr_id][0]][4] = x;
...
inline void extract_forward_3_path(int thr_id) {
    ...
    for (int i=sorted_backward_3_path_from[thr_id][v]; i<sorted_backward_3_path_to[thr_id][v]; ++i) {
        ...
        y = sorted_backward_3_path_fin[thr_id][i][1];
        if (visit[thr_id][x] == mask[thr_id][0] || visit[thr_id][y] == mask[thr_id][0]) continue;
        memcpy(answer_6[thr_id][answer_5_6_7_num[thr_id][1]], dfs_path[thr_id], sizeof(int) * 4);
        answer_6[thr_id][answer_5_6_7_num[thr_id][1]][4] = y;
        answer_6[thr_id][answer_5_6_7_num[thr_id][1]][5] = x;
...
inline void extract_forward_4_path(int thr_id) {
    ...
    for (int i=sorted_backward_3_path_from[thr_id][v]; i<sorted_backward_3_path_to[thr_id][v]; ++i) {
        ...
        y = sorted_backward_3_path_fin[thr_id][i][1];
        if (visit[thr_id][x] == mask[thr_id][0] || visit[thr_id][y] == mask[thr_id][0]) continue;
        memcpy(answer_7[thr_id][answer_5_6_7_num[thr_id][2]], dfs_path[thr_id], sizeof(int) * 5);
        answer_7[thr_id][answer_5_6_7_num[thr_id][2]][5] = y;
        answer_7[thr_id][answer_5_6_7_num[thr_id][2]][6] = x;
...
void do_search_mim(int begin_with, int thr_id) {
    ...
    answer_5_from[thr_id][begin_with] = answer_5_6_7_num[thr_id][0];
    answer_6_from[thr_id][begin_with] = answer_5_6_7_num[thr_id][1];
    answer_7_from[thr_id][begin_with] = answer_5_6_7_num[thr_id][2];
    forward_dfs(thr_id);
    answer_3_to[thr_id][begin_with] = answer_3_buffer_num[thr_id][0];
    answer_4_to[thr_id][begin_with] = answer_4_buffer_num[thr_id][0];
    answer_5_to[thr_id][begin_with] = answer_5_6_7_num[thr_id][0];
    answer_6_to[thr_id][begin_with] = answer_5_6_7_num[thr_id][1];
    answer_7_to[thr_id][begin_with] = answer_5_6_7_num[thr_id][2];    
}
