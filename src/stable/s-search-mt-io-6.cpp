...
void* deserialize_ans_mt_0(void* args) {
    ...
    for (int y=0; y<node_num; ++y) {
        ...
        } else if (global_search_assignment[y] == 3) {
        ...
        } else if (global_search_assignment[y] == 4) {
...
// io thread 1
char CACHE_LINE_ALIGN output_buffer_mt_1[ONE_INT_CHAR_SIZE * MAX_ANSW * 4];
...
// io thread 2
char CACHE_LINE_ALIGN output_buffer_mt_2[ONE_INT_CHAR_SIZE * MAX_ANSW * 5];
...
// io thread 3
char CACHE_LINE_ALIGN output_buffer_mt_3[ONE_INT_CHAR_SIZE * MAX_ANSW * 6];
...
// io thread 4
char CACHE_LINE_ALIGN output_buffer_mt_4[ONE_INT_CHAR_SIZE * MAX_ANSW * 7];
...
int main() {
    ...
    answer_num = answer_num_mt_0 + answer_num_mt_1 + answer_num_mt_2 + answer_num_mt_3 + answer_num_mt_4 + answer_num_mt_5 - 6;
