...
void deserialize_3(char* buffer, int& buffer_index, int from, int to) {
    ...
    for (int u=from; u<to; ++u) {
        ...
        case 0:
            ...
            header = answer_header_0[0][u];
            tailer = answer_tailer_0[0][u];
            break;
        case 1:
            local_answer = answer_3_1; 
            header = answer_header_1[0][u];
            tailer = answer_tailer_1[0][u];
            break;
        case 2:
            local_answer = answer_3_2; 
            header = answer_header_2[0][u];
            tailer = answer_tailer_2[0][u];
            break;
        case 3:
            local_answer = answer_3_3; 
            header = answer_header_3[0][u];
            tailer = answer_tailer_3[0][u];
            break;
        default:
            break;
        }
...
void deserialize_4(char* buffer, int& buffer_index, int from, int to) {
    ...
    for (int u=from; u<to; ++u) {
        ...
        case 0:
            ...
            header = answer_header_0[1][u];
            tailer = answer_tailer_0[1][u];
            break;
        case 1:
            local_answer = answer_4_1; 
            header = answer_header_1[1][u];
            tailer = answer_tailer_1[1][u];
            break;
        case 2:
            local_answer = answer_4_2; 
            header = answer_header_2[1][u];
            tailer = answer_tailer_2[1][u];
            break;
        case 3:
            local_answer = answer_4_3; 
            header = answer_header_3[1][u];
            tailer = answer_tailer_3[1][u];
            break;
        default:
            break;
        }
...
void deserialize_5(char* buffer, int& buffer_index, int from, int to) {
    ...
    for (int u=from; u<to; ++u) {
        ...
        case 0:
            ...
            header = answer_header_0[2][u];
            tailer = answer_tailer_0[2][u];
            break;
        case 1:
            local_answer = answer_5_1; 
            header = answer_header_1[2][u];
            tailer = answer_tailer_1[2][u];
            break;
        case 2:
            local_answer = answer_5_2; 
            header = answer_header_2[2][u];
            tailer = answer_tailer_2[2][u];
            break;
        case 3:
            local_answer = answer_5_3; 
            header = answer_header_3[2][u];
            tailer = answer_tailer_3[2][u];
            break;
        default:
            break;
        }
...
void deserialize_6(char* buffer, int& buffer_index, int from, int to) {
    ...
    for (int u=from; u<to; ++u) {
        ...
        case 0:
            ...
            header = answer_header_0[3][u];
            tailer = answer_tailer_0[3][u];
            break;
        case 1:
            local_answer = answer_6_1; 
            header = answer_header_1[3][u];
            tailer = answer_tailer_1[3][u];
            break;
        case 2:
            local_answer = answer_6_2; 
            header = answer_header_2[3][u];
            tailer = answer_tailer_2[3][u];
            break;
        case 3:
            local_answer = answer_6_3; 
            header = answer_header_3[3][u];
            tailer = answer_tailer_3[3][u];
            break;
        default:
            break;
        }
...
void deserialize_7(char* buffer, int& buffer_index, int from, int to) {
    ...
    for (int u=from; u<to; ++u) {
        ...
        case 0:
            ...
            header = answer_header_0[4][u];
            tailer = answer_tailer_0[4][u];
            break;
        case 1:
            local_answer = answer_7_1; 
            header = answer_header_1[4][u];
            tailer = answer_tailer_1[4][u];
            break;
        case 2:
            local_answer = answer_7_2; 
            header = answer_header_2[4][u];
            tailer = answer_tailer_2[4][u];
            break;
        case 3:
            local_answer = answer_7_3; 
            header = answer_header_3[4][u];
            tailer = answer_tailer_3[4][u];
            break;
        default:
            break;
        }
...
void* write_thr_1(void* args) { 
    write_buffer_1 = (char*) malloc(sizeof(char) * total_answer_num * ONE_INT_CHAR_SIZE * 6); 
    deserialize_7(write_buffer_1, write_buffer_num_1, 0, div_7[0]); 
    return NULL; 
}

def_write_declar(2) 
void* write_thr_2(void* args) { 
    write_buffer_2 = (char*) malloc(sizeof(char) * total_answer_num * ONE_INT_CHAR_SIZE * 6); 
    deserialize_7(write_buffer_2, write_buffer_num_2, div_7[0], div_7[1]); 
    return NULL; 
}

def_write_declar(3) 
void* write_thr_3(void* args) { 
    write_buffer_3 = (char*) malloc(sizeof(char) * total_answer_num * ONE_INT_CHAR_SIZE * 6); 
    deserialize_7(write_buffer_3, write_buffer_num_3, div_7[1], div_7[2]); 
    return NULL; 
}

def_write_declar(4) 
void* write_thr_4(void* args) { 
    write_buffer_4 = (char*) malloc(sizeof(char) * total_answer_num * ONE_INT_CHAR_SIZE * 6); 
    deserialize_7(write_buffer_4, write_buffer_num_4, div_7[2], node_num); 
    return NULL; 
}
...
void do_write() {
    ...
    int total_answer_7 = answer_num_0[4] + answer_num_1[4] + answer_num_2[4] + answer_num_3[4];
    int div = total_answer_7 / 4;

    // printf("total answer 7: %d %d\n", total_answer_7, div);

#define def_div_case(tid) \
        case tid: \
            pos += answer_tailer_##tid[4][i] - answer_header_##tid[4][i]; \
            break;

    int pos = 0, plz = 0;
    for (int i=0; i<node_num; ++i) {
        switch (global_assign[i])
        {
        def_div_case(0)
        def_div_case(1)
        def_div_case(2)
    ...
    printf("div: %d %d %d\n", div_7[0], div_7[1], div_7[2]);

    pthread_t write_thr[5];
    ...
    for (int i=0; i<5; ++i) pthread_join(write_thr[i], NULL);
    ...
    printf("%d\n%d\n%d\n%d\n", write_buffer_num_0, write_buffer_num_1,
         write_buffer_num_2, write_buffer_num_3);
    ...
    for (int i=2; i<5; ++i) write_from[i] += write_from[i-1];

    int write_len = write_from[4] + write_buffer_num_4;
    ...
    for (int i=0; i<5; ++i) pthread_join(disk_thr[i], NULL);
