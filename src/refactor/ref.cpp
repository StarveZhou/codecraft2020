...
void* write_thr_1(void* args) { 
    ...
    deserialize(write_buffer_1, write_buffer_num_1, 4, 0, node_num / 10); 
    return NULL; 
}
...
void* write_thr_2(void* args) { 
    ...
    deserialize(write_buffer_2, write_buffer_num_2, 4, node_num / 10, node_num / 5); 
    return NULL; 
}
...
void* write_thr_3(void* args) { 
    ...
    deserialize(write_buffer_3, write_buffer_num_3, 4, node_num / 5, node_num / 3); 
    return NULL; 
}
...
void* write_thr_4(void* args) { 
    ...
    deserialize(write_buffer_4, write_buffer_num_4, 4, node_num / 3, node_num / 2); 
    return NULL; 
}
