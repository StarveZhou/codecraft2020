...
#define OUTPUT_PATH  "ss_search.txt"
...
int CACHE_LINE_ALIGN answer_num_mt_0 = 1, answer_contain_num_mt_0 = 0, answer_mapper_id_mt_0 = -1;
...
void extract_answer_mt_0() {
    memcpy(all_answer_mt_0[answer_num_mt_0], dfs_path_mt_0 + 1, (depth_mt_0-1) * sizeof(int));
    int x = depth_mt_0 - 3, y = answer_mapper_id_mt_0;
...
int CACHE_LINE_ALIGN answer_num_mt_1 = 1, answer_contain_num_mt_1 = 0, answer_mapper_id_mt_1 = -1;
...
void extract_answer_mt_1() {
    memcpy(all_answer_mt_1[answer_num_mt_1], dfs_path_mt_1 + 1, (depth_mt_1-1) * sizeof(int));
    int x = depth_mt_1 - 3, y = answer_mapper_id_mt_1;
...
int CACHE_LINE_ALIGN answer_num_mt_2 = 1, answer_contain_num_mt_2 = 0, answer_mapper_id_mt_2 = -1;
...
void extract_answer_mt_2() {
    memcpy(all_answer_mt_2[answer_num_mt_2], dfs_path_mt_2 + 1, (depth_mt_2-1) * sizeof(int));
    int x = depth_mt_2 - 3, y = answer_mapper_id_mt_2;
...
int CACHE_LINE_ALIGN answer_num_mt_3 = 1, answer_contain_num_mt_3 = 0, answer_mapper_id_mt_3 = -1;
...
void extract_answer_mt_3() {
    memcpy(all_answer_mt_3[answer_num_mt_3], dfs_path_mt_3 + 1, (depth_mt_3-1) * sizeof(int));
...
// io thread 0
char CACHE_LINE_ALIGN output_buffer_mt_0[ONE_INT_CHAR_SIZE * MAX_ANSW * 3 + 100];
        ...
        if (global_search_assignment[y] == 0) {
            if (likely(answer_header_mt_0[x][y_0] != 0)) {
                for (int i=answer_header_mt_0[x][y_0]; i!=0; i=all_answer_ptr_mt_0[i]) {
                    deserialize_id_mt_0(y);
                    output_buffer_mt_0[buffer_index_mt_0 ++] = ',';
                    for (int j=0; j<x_2; ++j) {
                        deserialize_id_mt_0(all_answer_mt_0[i][j]);
                        output_buffer_mt_0[buffer_index_mt_0 ++] = j == x_1 ? '\n' : ',';
                    }
                }
            }
            ++ y_0;
...
// io thread 1
char CACHE_LINE_ALIGN output_buffer_mt_1[ONE_INT_CHAR_SIZE * MAX_ANSW * 3 + 100];
...
void* deserialize_ans_mt_1(void* args) {
    ...
    for (int y=0; y<node_num; ++y) {
        if (global_search_assignment[y] == 0) {
            if (likely(answer_header_mt_0[x][y_0] != 0)) {
                for (int i=answer_header_mt_0[x][y_0]; i!=0; i=all_answer_ptr_mt_0[i]) {
                    deserialize_id_mt_1(y);
                    output_buffer_mt_1[buffer_index_mt_1 ++] = ',';
                    for (int j=0; j<x_2; ++j) {
                        deserialize_id_mt_1(all_answer_mt_0[i][j]);
                        output_buffer_mt_1[buffer_index_mt_1 ++] = j == x_1 ? '\n' : ',';
                    }
                }
            }
            ++ y_0;
...
// io thread 2
char CACHE_LINE_ALIGN output_buffer_mt_2[ONE_INT_CHAR_SIZE * MAX_ANSW * 3 + 100];
...
void* deserialize_ans_mt_2(void* args) {
    ...
    for (int y=0; y<node_num; ++y) {
        if (global_search_assignment[y] == 0) {
            if (likely(answer_header_mt_0[x][y_0] != 0)) {
                for (int i=answer_header_mt_0[x][y_0]; i!=0; i=all_answer_ptr_mt_0[i]) {
                    deserialize_id_mt_2(y);
                    output_buffer_mt_2[buffer_index_mt_2 ++] = ',';
                    for (int j=0; j<x_2; ++j) {
                        deserialize_id_mt_2(all_answer_mt_0[i][j]);
                        output_buffer_mt_2[buffer_index_mt_2 ++] = j == x_1 ? '\n' : ',';
                    }
                }
            }
            ++ y_0;
...
// io thread 3
char CACHE_LINE_ALIGN output_buffer_mt_3[ONE_INT_CHAR_SIZE * MAX_ANSW * 3 + 100];
...
void* deserialize_ans_mt_3(void* args) {
    ...
    for (int y=0; y<node_num; ++y) {
        if (global_search_assignment[y] == 0) {
            if (likely(answer_header_mt_0[x][y_0] != 0)) {
                for (int i=answer_header_mt_0[x][y_0]; i!=0; i=all_answer_ptr_mt_0[i]) {
                    deserialize_id_mt_3(y);
                    output_buffer_mt_3[buffer_index_mt_3 ++] = ',';
                    for (int j=0; j<x_2; ++j) {
                        deserialize_id_mt_3(all_answer_mt_0[i][j]);
                        output_buffer_mt_3[buffer_index_mt_3 ++] = j == x_1 ? '\n' : ',';
                    }
                }
            }
            ++ y_0;
            ...
            if (likely(answer_header_mt_0[x][y_0] != 0)) {
                for (int i=answer_header_mt_0[x][y_0]; i!=0; i=all_answer_ptr_mt_0[i]) {
                    ...
                    for (int j=0; j<x_2; ++j) {
                        ...
                        output_buffer_mt_4[buffer_index_mt_4 ++] = j == x_1 ? '\n' : ',';
                    }
                }
            }
            ++ y_0;
...
void write_to_disk() {
    ssize_t temp;
    pthread_t deserialize_thr[5];
    pthread_create(deserialize_thr + 0, NULL, deserialize_ans_mt_0, NULL);
    pthread_create(deserialize_thr + 1, NULL, deserialize_ans_mt_1, NULL);
    pthread_create(deserialize_thr + 2, NULL, deserialize_ans_mt_2, NULL);
    pthread_join(deserialize_thr[0], NULL);
    pthread_create(deserialize_thr + 3, NULL, deserialize_ans_mt_3, NULL);
    temp = write(writer_fd, output_buffer_mt_0, buffer_index_mt_0);
    pthread_join(deserialize_thr[1], NULL);
    pthread_create(deserialize_thr + 4, NULL, deserialize_ans_mt_4, NULL);
