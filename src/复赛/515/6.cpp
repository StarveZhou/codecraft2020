    ...
    while (s_num --) { \
        ...
        if (bck_step_visit_##tid[a]) { \
            ...
            while (bck_step != NULL) { \
                ...
                if (fx > 5LL * sx || sx > 3LL * fx || sx > 5LL * dx || dx > 3LL * sx){ \
            ...
            if (bck_step_visit_##tid[b]) { \
                ...
                while (bck_step != NULL) { \
                    ...
                    if (b == f || a == f) { \
                        ...
                        size_bck = bck_step -> size; \
                        bck_step = bck_step -> nxt; \
                        if (fx > 5LL * sx || sx > 3LL * fx || ax > 5LL * dx || dx > 3LL * ax) { \
                            continue; \
                        } else { \
                ...
                if (bck_step_visit_##tid[c]) { \
                    ...
                    while (bck_step != NULL) { \
                        ...
                        if (a == f || b == f || c == f) { \
                            ...
                            size_bck = bck_step -> size; \
                            bck_step = bck_step -> nxt; \
                            if (fx > 5LL * sx || sx > 3LL * fx || bx > 5LL * dx || dx > 3LL * bx) { \
                                continue; \
                            } else { \
                        ...
                        if (bck_step_visit_##tid[d]) { \
                            ...
                            while (bck_step != NULL) { \
                                ...
                                if (a == f || b == f || c == f || d == f) { \
                                    ...
                                    size_bck = bck_step -> size; \
                                    bck_step = bck_step -> nxt; \
                                    if (fx > 5LL * sx || sx > 3LL * fx || cx > 5LL * dx || dx > 3LL * cx) { \
                                        continue; \
                                    } else { \
...
void create_integer_buffer() {
    ...
    for (; i<node_num; ++i) {
        ...
        integer_buffer[i][integer_buffer_size[i] ++] = ',';
        while (unlikely(x)) {
