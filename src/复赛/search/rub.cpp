...
int* rev_data_mapping = (int*)malloc(sizeof(int) * MAX_NODE);
...
int fwd_edges_num = 0;
int* fwd_edges = (int*)malloc(sizeof(int) * MAX_EDGE);
int* fwd_headers = (int*)malloc(sizeof(int) * MAX_NODE);
long long* fwd_value = (long long*)malloc(sizeof(long long) * MAX_EDGE);
...
int bck_edges_num = 0;
int* bck_edges = (int*)malloc(sizeof(int) * MAX_EDGE);
int* bck_headers = (int*)malloc(sizeof(int) * MAX_NODE);
long long* bck_value = (long long*)malloc(sizeof(long long) * MAX_EDGE);

void fire_build_edge() {
#define def_build_malloc(nid) \
    raw_edges_chain_header_##nid = (int*)malloc(sizeof(int) * MAX_NODE); \
    raw_edges_chain_nxt_##nid = (int*)malloc(sizeof(int) * MAX_EDGE); \
    raw_edges_chain_v_##nid = (int*)malloc(sizeof(int) * MAX_EDGE); \
    raw_edges_chain_value_##nid = (int*)malloc(sizeof(int) * MAX_EDGE); \
    raw_edges_header_##nid = (int*)malloc(sizeof(int) * MAX_NODE); \
    raw_edges_v_fake_##nid = (int*)malloc(sizeof(int) * MAX_EDGE); \
    raw_edges_value_fake_##nid = (long long*)malloc(sizeof(long long) * MAX_EDGE); \
    raw_edges_v_##nid = (int*)malloc(sizeof(int) * MAX_EDGE); \
    raw_edges_value_##nid = (long long*)malloc(sizeof(long long) * MAX_EDGE); \
    raw_edges_id_##nid = (int*)malloc(sizeof(int) * MAX_EDGE); \
    raw_rev_edges_chain_v_##nid = (int*)malloc(sizeof(int) * MAX_EDGE); \
    raw_rev_edges_chain_header_##nid = (int*)malloc(sizeof(int) * MAX_NODE); \
    raw_rev_edges_chain_nxt_##nid = (int*)malloc(sizeof(int) * MAX_NODE); \
    raw_rev_edges_chain_value_##nid = (long long*)malloc(sizeof(long long) * MAX_EDGE); 
...
#define def_build_edges_free(nid) \
    ...
    def_build_edges_free(0)
    def_build_edges_free(1)
    def_build_edges_free(2)
    def_build_edges_free(3)
    def_build_edges_free(4)
    def_build_edges_free(5)
}
...
int* global_search_assign = (int*)malloc(sizeof(int) * MAX_EDGE);
...
int answer_num_##tid = 0, answer_bck_num_##tid = MAX_ANSW; \
\
int* fwd_starter_##tid = (int*)malloc(sizeof(int) * MAX_EDGE); \
...
int* bck_search_1_visit_##tid = (int*)malloc(sizeof(int) * MAX_NODE); \
int bck_search_1_mask_##tid = 123; \
\
int bck_search_1_queue_num_##tid = 0; \
int* bck_search_1_queue_edges_##tid = (int*)malloc(sizeof(int) * MAX_BCK_1); \
long long* bck_search_1_queue_values_##tid = (long long*)malloc(sizeof(long long) * MAX_BCK_1); \
int* bck_search_1_queue_header_##tid = (int*)malloc(sizeof(int) * MAX_NODE); \
\
...
\
int* bck_search_2_visit_##tid = (int*)malloc(sizeof(int) * MAX_NODE); \
int bck_search_2_mask_##tid = 1234; \
\
int bck_search_2_queue_num_##tid = 0; \
int bck_search_2_queue_edges_##tid[MAX_BCK_2][2]; \
long long* bck_search_2_queue_values_##tid = (long long*)malloc(sizeof(long long) * MAX_EDGE); \
int* bck_search_2_queue_header_##tid = (int*)malloc(sizeof(int) * MAX_NODE); \
int* bck_search_2_queue_nxt_##tid = (int*)malloc(sizeof(int) * MAX_BCK_2); \
\
int* bck_search_2_sorted_visit_##tid = (int*)malloc(sizeof(int) * MAX_NODE); \
int* bck_search_2_sorted_id_from_##tid = (int*)malloc(sizeof(int) * MAX_NODE); \
int* bck_search_2_sorted_id_to_##tid = (int*)malloc(sizeof(int) * MAX_NODE); \
int* bck_search_2_sorted_id_##tid = (int*)malloc(sizeof(int) * MAX_NODE); \
...
\
int* bck_search_3_visit_##tid = (int*)malloc(sizeof(int) * MAX_NODE); \
int bck_search_3_mask_##tid = 12345; \
\
int bck_search_3_queue_num_##tid = 0; \
int bck_search_3_queue_edges_##tid[MAX_BCK_3][3]; \
long long* bck_search_3_queue_values_##tid = (long long*)malloc(sizeof(long long) * MAX_BCK_3); \
int* bck_search_3_queue_header_##tid = (int*)malloc(sizeof(int) * MAX_NODE); \
int* bck_search_3_queue_nxt_##tid = (int*)malloc(sizeof(int) * MAX_BCK_3); \
\
int* bck_search_3_sorted_visit_##tid = (int*)malloc(sizeof(int) * MAX_NODE); \
int* bck_search_3_sorted_id_from_##tid = (int*)malloc(sizeof(int) * MAX_NODE); \
int* bck_search_3_sorted_id_to_##tid = (int*)malloc(sizeof(int) * MAX_NODE); \
int* bck_search_3_sorted_id_##tid = (int*)malloc(sizeof(int) * MAX_BCK_3); \
...
int* fwd_search_1_queue_edges_##tid = (int*)malloc(sizeof(int) * MAX_BCK_1); \
long long* fwd_search_1_queue_values_##tid = (long long*)malloc(sizeof(long long) * MAX_BCK_3); \
\
void fwd_1_bfs_##tid(int left, int right, long long x, int global_id) { \
    ...
    for (int i=fwd_starter_##tid[right]; i<fwd_headers[right+1]; ++i) { \
        ...
        if (check_x_y(x, y)) { \
            ...
            printf("fwd 1: %d %d %d %lld %lld %lld %d\n", rev_data_mapping[left], rev_data_mapping[right], rev_data_mapping[v], x, y, z, check_x_y(y, z)); \
...
long long* fwd_search_2_queue_values_##tid = (long long*)malloc(sizeof(long long) * MAX_BCK_2); \
\
        ...
        for (int j=fwd_starter_##tid[u]; j<fwd_headers[u+1]; ++j) { \
            ...
            if (bck_search_2_visit_##tid[v] == bck_search_2_mask_##tid) { \
                ...
                for (int k=bck_search_2_sorted_id_from_##tid[v]; k<bck_search_2_sorted_id_to_##tid[v]; ++k) { \
                    index = bck_search_2_sorted_id_##tid[k]; \
                    z = bck_search_2_queue_values_##tid[index]; \
                    w = bck_search_2_queue_edges_##tid[index][1]; \
...
void do_search_##tid(int left, int right, long long x, int global_id) { \
    printf("[%d] do search: %d %d %lld %d\n", tid, rev_data_mapping[left], rev_data_mapping[right], x, global_id); \
