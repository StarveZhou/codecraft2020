...
void do_hash() {
    ...
    i = 0;
    while (i < size) {
        radix_index_b[radix_from[radix_index[radix_index_a[i]]&255] ++] = radix_index_a[i];
        i ++;
    }
    ...
    i = 0;
    while (i < size) {
        radix_index_a[radix_from[radix_index[radix_index_b[i]]>>8&255] ++] = radix_index_b[i];
        i ++;
    }
    ...
    i = 0;
    while (i < size) {
        radix_index_b[radix_from[radix_index[radix_index_a[i]]>>16&255] ++] = radix_index_a[i];
        i ++;
    }
    ...
    i = 0;
    while (i < size) {
        radix_index_a[radix_from[radix_index[radix_index_b[i]]>>24&255] ++] = radix_index_b[i];
        i ++;
    }

    // printf("after radix %d\n", size); fflush(stdout);

    // rehash
    data[radix_index_a[0]>>1][radix_index_a[0]&1] = node_num;
    data_rev_mapping[node_num] = radix_index[radix_index_a[0]];
    for(i=1; i<size; ++i) {
        // printf("radix: %d %d %d %d %d\n", i, size , radix_index_a[i], radix_index[radix_index_a[i]], node_num); 
        // printf("%d %d\n", radix_index_a[i]>>1, radix_index_a[i]&1);
        // fflush(stdout);
